...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'personal.strength'
        db.alter_column('student_info_personal', 'strength', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'personal.mother_occupation'
        db.alter_column('student_info_personal', 'mother_occupation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'personal.weakness'
        db.alter_column('student_info_personal', 'weakness', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'personal.father_occupation'
        db.alter_column('student_info_personal', 'father_occupation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'personal.strength'
        raise RuntimeError("Cannot reverse this migration. 'personal.strength' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'personal.mother_occupation'
        raise RuntimeError("Cannot reverse this migration. 'personal.mother_occupation' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'personal.weakness'
        raise RuntimeError("Cannot reverse this migration. 'personal.weakness' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'personal.father_occupation'
        raise RuntimeError("Cannot reverse this migration. 'personal.father_occupation' and its values cannot be restored.")
